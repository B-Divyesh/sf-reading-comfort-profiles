...
- Sample: a quarterly access-review document with realistic prose, a code decision, and three request rows. On a 390 × 844 phone, the document heading and review note appear in the first demo viewport before the settings form. The seeded Calm reading profile uses 19 px prose, 1.65 line spacing, 17 px code, stronger contrast, and roomier tables.
...
- Exit: **Leave demo** deletes the demo key before returning home.
